					...
					<div class="login-input">					
						<ul>
							<li>
								...
								<input type="text" class="input"  name="id" placeholder="아이디를 입력해주세요." maxlength="20" autofocus />
							</li>
							
							<li>
								<label class="hidden">비밀번호</label>
								<input type="password" class="input" name="password" placeholder="비밀번호를 입력해주세요." maxlength="20" />
							</li>
						</ul>
