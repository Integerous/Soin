...
<body>
 ...
 <!-- ------후기들시작----------------------------------  -->
 	<c:forEach var="ai" items="${list}" >
		...
		<li style="text-align: center;">업체명${ai.memberId}</li>
		<li>문${ai.constructionTypeId}</li>
		<li style="font-size:11px">튼튼하고 견고한 문으로 바꿔서 좋아해요 ${ai.title}</li>
		</ul>
		</div>
		...
		<div class="company-content2">
			<a href=""><img class="img-interior" src="../../../Images/yurim/타일1.jpg" alt="타일1"/></a>
				<ul class="text-ellipsis">
				<li style="text-align: center;">업체명${ai.memberId}</li>
				<li>벽지${ai.constructionTypeId}</li>
				<li style="font-size:11px">화사한 벽지로 변신!!${ai.title}</li>
				</ul>
		</div>
	...
	<div class="company-content2">
		<a href=""><img class="img-interior" src="../../../Images/yurim/창문1.jpg" alt="창문1"/></a>
			<ul class="text-ellipsis">
				<li style="text-align: center;">업체명${ai.memberId}</li>
				<li>창문${ai.constructionTypeId}</li>
				<li style="font-size:11px">확트인만큼 빛도 많이 들어오네?${ai.title}</li>
			</ul>
			</div>
  ...
  <div class="company-content2">
			...
			<li style="text-align: center;">업체명${ai.memberId}</li>
			<li>창문${ai.constructionTypeId}</li>
			<li style="font-size:11px">실내 창문의 또다른 혁명! 너도나도 고고고${ai.title}</li>
			</ul>
			</div>
		...
		<a href=""><img class="img-interior" src="../../../Images/yurim/욕실1.jpg" alt="욕실1"/></a>
			<ul class="text-ellipsis">
			<li style="text-align: center;">업체명${ai.memberId}</li>
			<li>욕실${ai.constructionTypeId}</li>
		<li style="font-size:11px">깔끔한 모노톤으로 시공완료!${ai.title}</li>
		</ul>
		</div>
		...
		<ul class="text-ellipsis">
			<li style="text-align: center;">업체명${ai.memberId}</li>
			<li>욕실${ai.constructionTypeId}</li>
			<li style="font-size:11px">세면대와 변기를 바꿨어요${ai.title}</li>
		</ul>
		</div>
		  </div>
		  ...
		  <div class="company-content2">
		 	 ...
		 	 <ul class="text-ellipsis">
		 	 	<li style="text-align: center;">업체명 ${ai.memberId}</li>
				<li>창문${ai.constructionTypeId}</li>
				<li style="font-size:11px">최대한 위에 창문을 달았네요${ai.title}</li>
			</ul>
 		 </div>
 		 <div class="company-content2">
  		<a href=""><img class="img-interior" src="../../../Images/yurim/타일1.jpg" alt="타일1"/></a>
  		...
  		<li style="text-align:center;">업체명${ai.memberId}</li>
		<li>문${ai.constructionTypeId}</li>
		<li style="font-size:11px">같은 색으로 통일했네요 친환경스타일 ${ai.title}</li>
		</ul>
		  </div>
		  </div>
		  </div>
