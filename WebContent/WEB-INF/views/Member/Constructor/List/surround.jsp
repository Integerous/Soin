...
<c:set var="ctx" value="${pageContext.request.servletContext.contextPath }"/> 
			...
			<section>
				...
				<section>
				<c:forEach var="constructor" items="${list}" begin="0" end="15">
					<div class="distance">	
						<a href="Detail?id=${constructor.member_id }">
							<img src="${ctx }/Images/jyh/Adela.jpg" alt="아델라">
						</a>
							<ul>
								<li><a href="Detail?id=${constructor.member_id }">${constructor.name }</a></li>
								<li><a href="Detail?id=${constructor.member_id }">평점 : ${constructor.gpa}</a></li>
						</ul>
