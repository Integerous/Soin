...
<!------------------------------------main 시작 ---------------------------------->
	<main id = "main">
		...
		<table class = "main-table3">
			...
			<tr>
				<th>비밀번호</th>
				<td><input type="password" class="input-text" value="" placeholder="비밀번호를 입력해주세요." maxlength="50"></td>
			</tr>
			
			<tr>
				<th>비밀번호확인</th>
				<td><input type="password" class="input-text" value="" placeholder="비밀번호를 다시 입력해주세요." maxlength="50"></td>
			</tr>
			...
			<tr>
				<th>닉네임</th>
				<td><input type="text" class="input-text" ></td></td>
			</tr>
		...
		<input type="button" value="저장하기" onclick="location.href='#">
		</section>
			
		<section class="button button2">
		<input type="button" value="회원탈퇴하기" onclick="location.href='#">
		</section>
