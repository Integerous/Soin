...
@WebServlet("/member/constructor/list/build")
public class BuildListController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		container.render("Member.Constructor.List.build", servletRequest);
